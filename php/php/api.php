...
if($action=='login'){
    ...
    $CheckQuery = "select `userName`,`role` from user where (`userName`='".$request['userName']."' or `email`='".$request['userName']."') AND `password`='".$request['password']."'";
    ...
    if ($result !== false && $result->num_rows > 0) {
        ...
        $payLoad = array(   "userName"=>$request['userName'],
